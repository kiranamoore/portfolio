...
export default function HyperXUnityWebARPage() {
  ...
  const slides = [
    { type: "video", src: "/unity-ar.mp4", caption: "JavaScript Web AR with marker-based tracking demonstration" },
  ];
          ...
          <div className="flex-1 flex flex-col min-h-0">
            ...
            <div className="flex-shrink-0 mb-6">
              ...
              <div className="flex flex-wrap gap-3 mb-8">
                <span className="inline-block font-medium text-[#667eea] bg-[#667eea]/10 rounded-lg" style={{ padding: '6px 14px', fontSize: '12px' }}>JavaScript</span>
                <span className="inline-block font-medium text-[#667eea] bg-[#667eea]/10 rounded-lg" style={{ padding: '6px 14px', fontSize: '12px' }}>WebAR</span>
                <span className="inline-block font-medium text-[#667eea] bg-[#667eea]/10 rounded-lg" style={{ padding: '6px 14px', fontSize: '12px' }}>Three.js</span>
              </div>
              ...
              <div className="rounded-xl" style={{ padding: '8px 0' }}>
                ...
                <ul className="text-[14px] text-[#1D1D1F] space-y-2 pl-11">
                  <li className="flex items-start gap-2">
                    ...
                    <span>Created a <strong>marker-based AR system</strong> using pure JavaScript and web technologies.</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-[#667eea] mt-1">•</span>
                    <span>Developed <strong>real-time computer vision algorithms</strong> for precise marker detection and 3D positioning in browsers.</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-[#667eea] mt-1">•</span>
                    <span>Created a <strong>scalable AR framework</strong> deployable across multiple devices without native apps or Unity dependencies.</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="rounded-xl" style={{ padding: '8px 0' }}>
                ...
                <ul className="text-[14px] text-[#1D1D1F] space-y-2 pl-11">
                  <li className="flex items-start gap-2">
                    ...
                    <span>Implemented <strong>marker detection algorithms</strong> using JavaScript computer vision libraries for real-time tracking.</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-[#f093fb] mt-1">•</span>
                    <span>Developed <strong>JavaScript integration</strong> with browser APIs for camera access and device orientation.</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-[#f093fb] mt-1">•</span>
                    <span>Created <strong>3D object positioning systems</strong> with sub-pixel precision using WebGL and Three.js.</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-[#f093fb] mt-1">•</span>
                    <span>Optimized <strong>rendering performance</strong> for mobile devices using efficient JavaScript shaders.</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="rounded-xl" style={{ padding: '8px 0' }}>
                ...
                <ul className="text-[14px] text-[#1D1D1F] space-y-2 pl-11">
                  <li className="flex items-start gap-2">
                    ...
                    <span><strong>Delivered production-ready Web AR</strong> that works smoothly and accurately across all devices.</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-[#4facfe] mt-1">•</span>
                    <span>Demonstrated <strong>advanced computer vision</strong> in web environments.</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-[#4facfe] mt-1">•</span>
                    <span>Established <strong>reusable AR framework</strong> for future HyperX products.</span>
                  </li>
                </ul>
              </div>
            </div>
