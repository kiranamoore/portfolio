        ...
        <div className="w-full max-w-7xl h-full max-h-[calc(100vh-8rem)] flex flex-col lg:flex-row gap-4 lg:gap-8">
          ...
          <div className="flex-1 flex flex-col min-h-0">
            ...
            <p className="text-[13px] text-[#6E6E73] mt-3 text-center">
              Digital Self Portrait - Spring 2025
            </p>
          </div>
          ...
          <div className="flex-1 flex flex-col min-h-0">
            ...
            <div className="flex-shrink-0 mb-6">
              ...
              <p className="text-[14px] font-semibold text-[#667eea] mb-4">Art-417: Digital Illustration Studio · Spring 2025</p>
              ...
              <div className="rounded-xl" style={{ padding: '8px 0' }}>
                ...
                <ul className="text-[14px] text-[#1D1D1F] space-y-2 pl-11">
                  <li className="flex items-start gap-2">
                    ...
                    <span><em>Magical Girl VS. Corporate Zombies</em> – Digital Self Portrait created in my junior year for Art-417: Digital Illustration Studio.</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-[#f093fb] mt-1">•</span>
                    <span><strong>This piece explores the tension between my dual identities: a vibrant, expressive artist and a disciplined office worker.</strong></span>
                  </li>
                </ul>
              </div>
              ...
              <div className="rounded-xl" style={{ padding: '8px 0' }}>
                ...
                <ul className="text-[14px] text-[#1D1D1F] space-y-2 pl-11">
                  <li className="flex items-start gap-2">
                    ...
                    <span>The illustration portrays a magical battle between a radiant Magical Girl and a horde of Corporate Zombies.</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-[#4facfe] mt-1">•</span>
                    <span><strong>The Magical Girl symbolizes my creative, self-expressive side, while the Corporate Zombies embody the structured, relentless demands of work, school, and professional ambition.</strong></span>
                  </li>
                </ul>
              </div>
              ...
              <div className="rounded-xl" style={{ padding: '8px 0' }}>
                ...
                <ul className="text-[14px] text-[#1D1D1F] space-y-2 pl-11">
                  <li className="flex items-start gap-2">
                    ...
                    <span>Through bold colors, dynamic composition, and playful symbolism, this illustration captures how my <strong>creative energy fuels resilience, even within rigid systems.</strong></span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-[#667eea] mt-1">•</span>
                    <span>It serves as both a personal reflection and a celebration of navigating dual worlds.</span>
                  </li>
                </ul>
              </div>
            </div>
