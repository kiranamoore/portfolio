...
export default function Cloud3DConnectPage() {
  return (
    <>
      ...
      >
        <div className="w-full flex flex-col lg:flex-row gap-16 items-start justify-center" style={{maxWidth: '1200px'}}>
          {/* Left column: Demo Video, 3D Model Viewer, and QR Code - order-2 on mobile, order-1 on desktop */}
          <div className="flex flex-col items-center justify-start flex-1 h-full space-y-6 order-2 lg:order-1">
