...
export default function ARProductCustomizerPage() {
  ...
  const slides = [
    { type: "video", src: "/Customizer_demo.MOV", caption: "Live AR Demo" },
    { type: "model", src: "/Cloud-3-S-7-17.glb", caption: "Interactive 3D Model - Drag to rotate" },
    { type: "image", src: "/customizer_qr_code.png", caption: "Scan to try on mobile" },
  ];
          ...
          <div className="flex-1 flex flex-col min-h-0">
            ...
            <div className="flex-shrink-0 mb-6">
              ...
              <p className="text-[15px] text-[#1D1D1F] leading-relaxed">
                Developed an interactive 3D experience that showcases key product highlights and allows in-store customers to customize HyperX's Cloud 3 S headset in real time.
              </p>
            </div>
