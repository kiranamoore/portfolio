      ...
      <div className="relative z-10 h-full flex items-center justify-center px-8 md:px-12 lg:px-16" style={{ paddingTop: '100px', paddingBottom: '40px' }}>
        ...
        <div className="w-full max-w-7xl h-full max-h-[calc(100vh-8rem)] flex flex-col lg:flex-row gap-4 lg:gap-8">
          ...
          <div className="flex-1 flex flex-col min-h-0">
            ...
            {/* Caption with itch.io link */}
            <p className="text-[13px] text-[#6E6E73] mt-3 text-center">
              Gameplay Demo |{" "}
              <a
                href="https://jelly-shroom.itch.io/robber-shooter-web-demo"
                target="_blank"
          ...
          <div className="flex-1 flex flex-col min-h-0">
            ...
            <div className="flex-shrink-0 mb-6">
              ...
              <div className="flex flex-wrap gap-3 mb-8">
                ...
                <span className="inline-block font-medium text-[#667eea] bg-[#667eea]/10 rounded-lg" style={{ padding: '6px 14px', fontSize: '12px' }}>VR</span>
              ...
              <div className="rounded-xl" style={{ padding: '8px 0' }}>
                ...
                <ul className="text-[14px] text-[#1D1D1F] space-y-2 pl-11">
                  <li className="flex items-start gap-2">
                    ...
                    <span>Served as <strong>Lead VR Developer and Game Designer</strong> to create a first-person VR heist experience.</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-[#667eea] mt-1">•</span>
                    <span>Aimed to deliver a <strong>fast-paced gameplay loop that challenges players to loot efficiently under pressure.</strong></span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-[#667eea] mt-1">•</span>
                    <span>Targeted blending urgency, exploration, and moral ambiguity in an immersive VR environment.</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="rounded-xl" style={{ padding: '8px 0' }}>
                ...
                <ul className="text-[14px] text-[#1D1D1F] space-y-2 pl-11">
                  <li className="flex items-start gap-2">
                    ...
                    <span>Built core environment and interaction logic using <strong>Unity</strong> and <strong>C#</strong> scripting.</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-[#f093fb] mt-1">•</span>
                    <span>Implemented <strong>VR hand tracking, object grabbing, and immersive input.</strong></span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-[#f093fb] mt-1">•</span>
                    <span>Designed gameplay mechanics where players loot stores by grabbing high-value items in limited time.</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-[#f093fb] mt-1">•</span>
                    <span>Evolved raycasting mechanics from traditional FPS to VR hand-based interactions.</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-[#f093fb] mt-1">•</span>
                    <span>Created building state displays via black-and-white overlay to show robbery progress.</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="rounded-xl" style={{ padding: '8px 0' }}>
                ...
                <ul className="text-[14px] text-[#1D1D1F] space-y-2 pl-11">
                  <li className="flex items-start gap-2">
                    ...
                    <span>Delivered a <strong>fully playable prototype for Meta Quest 3</strong> with core mechanics fully functional and tested.</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-[#4facfe] mt-1">•</span>
                    <span>Successfully expanded VR experience design beyond passive viewing or simple UI interactions.</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-[#4facfe] mt-1">•</span>
                    <span>Demonstrated ability to emphasize polish and core loop clarity under real-world time and tech constraints.</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-[#4facfe] mt-1">•</span>
                    <span>Established foundation for future iterations with potential for patrolling NPCs, dynamic AI, and enhanced environmental storytelling.</span>
                  </li>
                </ul>
              </div>
            </div>
